        ...
        <div class="profile-card">
            ...
            <form class="profile-form" method="POST" enctype="multipart/form-data">
                ...
                <div class="profile-image">
                        <img src="<?php echo "img/".$edit['freelancer_image'] ?>" alt="Profile Image" id="image-preview">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="price-hr" value="<?php echo $edit['price/hr']?>" name="price-hr" placeholder="Hourly Rate">
                </div>

                <div class="form-group">
                    <label for="phone_number">Phone Number</label>
                    <input type="number" id="phone_number" value="<?php echo $edit['phone_number']?>" name="phone" placeholder="Phone Number">
                </div>

                <div class="form-group">
                    <label for="available-hour">Available Hours per Week</label>
                    <input type="number" id="available-hour" value="<?php echo $edit['available_hours'] ?>" name="available-hour" placeholder="Hours per Week">
                </div>
