...
<div class="submenu">
    ...
    <div class="mainbtns">
                ...
                <button><a  href="accepted-requests.php?filter=applicant">Applicants</a></button>
                </div>
                <div class="submenu-item">
                <button><a  href="accepted-requests.php?filter=requests">Accepted Requests</a></button>
                </div>
                </div>
            </div>
