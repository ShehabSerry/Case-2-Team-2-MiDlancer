...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    <div class="container-xxl bg-white p-0 pt-5">
            <!-- Process Start -->
                 ...
                 <div class="row gy-5 gx-4 justify-content-center">
                     <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                         <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                             ...
                             <h5 class="mt-4 mb-3">sign-up</h5>
                             <p class="mb-0">join our platform and create your account to start connecting with top freelancers </p>
                         </div>
                     </div>
                     <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.3s">
                         <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                             ...
                             <p class="mb-0">build your profile, show case your skills and heighligh your experience to attract potential clients. </p>
                         </div>
                     </div>
                     <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.5s">
                         <div class="position-relative bg-light rounded pt-5 pb-4 px-4">
                             ...
                             <p class="mb-0">interview potential fits fo  freelancers to connect, share knowledge, and collaborate.</p>
                         </div>
                     </div>
                 </div>
             </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Clients can search for freelancers based on skills, experience, ratings, and location.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <h5 class="mb-3">Portfolio Upload</h5>
                        <p class="m-0">Freelancers can upload samples of their work in various formats (images,  documents)</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <h5 class="mb-3">Feedback System</h5>
                        <p class="m-0">Clients can leave reviews and rate freelancers based on their work with them.  </p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">A space for freelancers to connect, share knowledge, and collaborate.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Tools for freelancers to track premium deadline</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="feature-item bg-light rounded p-4">
                        ...
                        <p class="m-0">Ensuring the website is mobile-friendly for access on various devices</p>
                    </div>
                </div>
            </div>
        </div>
