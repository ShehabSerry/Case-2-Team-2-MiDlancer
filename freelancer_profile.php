...
<div class="profile-container">
    <?php foreach ($run_select as $data) { ?>
        <div class="profile-header">
            <img src="<?php echo "img/profile/" . $data['freelancer_image'] ?>" alt="User Image" class="profile-image">
            <div class="profile-info">
                ...
                <?php if (!empty($data['link2'])) { ?>
                    <p>GitHub: <a href="<?php echo $data['link2'] ?>" target="_blank">GitHub</a></p>
                <?php } else { ?>
                    <p>GitHub: ..</p>
                <?php } ?>
                <?php if (!empty($data['link1'])) { ?>
                    <p>LinkedIn: <a href="<?php echo $data['link1'] ?>" target="_blank">LinkedIn</a></p>
                <?php } else { ?>
                    <p>LinkedIn: ..</p>
                <?php } ?>
                <?php if (!$is_client) { ?>
        ...
        <?php foreach ($run_select_experience as $exper) { ?>
            <?php if (!empty($exper['experience_text'])) { ?>
                <div class="profile-experience">
                    <img src="<?php echo "img/" . $exper['experience_image'] ?>" alt=".." class="profile-image"> <!-- BACK GOTTA DECIDE FOLDER EXPR  -->
        ...
        <?php foreach ($run_select_skill as $sk) { ?>
            <?php if (!empty($sk['skill'])) { ?>
                <div class="profile-skills">
                    <p><?php echo $sk['skill'] ?>
                        <?php if (!$is_client) { ?>
                            <a href="freelancer_profile.php?delete=<?php echo $sk['skill_id'] ?>"><span class="trash-icon">🗑️</span></a>
                        <?php } ?>
                    </p>
                </div>
            <?php } else { ?>
