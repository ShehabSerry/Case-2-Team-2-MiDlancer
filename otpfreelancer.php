...
include 'mail.php';
$error = '';
if(isset($_SESSION['rand'], $_SESSION['national_id'])) // prevent hopping on the page
{
   $rand = $_SESSION['rand'];
      ...
      <body style='font-family: Arial, sans-serif; margin: 0; padding: 0; background-color: #fffffa; color: #00000a; line-height: 1.6;'>
          ...
          <div style='padding: 20px; background-color: #f7faffd3; color: #00000a; border-radius: 25px; box-shadow: -2px 13px 32px 0px rgba(0, 0, 0, 0.378); transition: all 0.5s; margin-top: 5%; margin-bottom: 5%;'>
              ...
              <div style='text-align: center''>
                  <h2 style='color: #080a74; background-color: #f6d673; font-weight: bold; padding: 10px; border-radius: 5px; text-align: center; display: inline-block;'>$rand</h2>
              </div>
...
else
{
   ...
   header("Location: login_freelancer.php"); // possible: login >redirect> home (if already logged in)
}
?>
<!DOCTYPE html>
<html lang="en">
