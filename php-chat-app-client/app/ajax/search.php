...
if (isset($_SESSION['user_id'])) {
    ...
    if(isset($_POST['key'])){
	   ...
	   join `freelancer` on freelancer.freelancer_id=payment.freelancer_id
       ...
       <li class="list-group-item">
		<a href="home.php?freelancer=<?=$user['freelancer_id']?>"
		   class="d-flex
       ...
       <?php } }else { ?>
         <div class="alert alert-info 
           ...
           The freelancer "<?=htmlspecialchars($_POST['key'])?>"
           is  not found.
		</div>
    <?php }
    }
